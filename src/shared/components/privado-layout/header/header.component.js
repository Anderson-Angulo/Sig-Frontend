...
const HeaderComponent = () => {
  ...
  const currentPages = useSelector(state => state.breadcrumpReducer.currentPages);
  ...
  return (
    <header className="header-route rounded-md" style={{ backgroundColor: '#fff', color: '#004680', }}    >
      <h2>{currentTitle}</h2>
